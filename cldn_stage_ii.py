...
parser.add_argument('--gpu', default=0, type=int,
                    help='GPU id to use.')
parser.add_argument('--teacher_ckpt', type=str, default="checkpoints/rafdb/stage_i/best_model.pth")
...
def train(train_loader, model, criterion, optimizer, args):
    ...
    for images, label in tqdm(train_loader):
        ...
        # compute output
        nkl_temperature = 1
        pred_h, pred_s, kd_loss = model(images, label, nkl_temperature)
